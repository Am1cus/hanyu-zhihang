<template>
  <div>
    <div class="page-heading">
      <div><h1>模型对比</h1><p>用相同的数据片段，比较LSTM和两种简单估算方法。</p></div>
    </div>
    <EnergyResearch />
    <details class="legacy-report disclosure"><summary>旧版V2报告（保留历史结论）</summary>
    <div class="actions"><el-button :icon="Refresh" :loading="loading" @click="loadReport">刷新旧版报告</el-button><el-button :icon="Download" :disabled="!report || !!error" @click="downloadJson(report, 'airsim-capacity-validation-v2.json')">下载旧版报告</el-button></div>
    ...
    <template v-else>
      ...
      <div class="experiment-columns">
        ...
        <section class="panel">
          <div class="panel-head"><h2>数据与划分</h2><span class="muted" style="font-size:0.875rem">按完整架次隔离</span></div>
...
<style scoped>
.legacy-report>summary{font-size:0.875rem;padding:18px 0;cursor:pointer;color:var(--muted)}
.experiment-banner{display:flex;align-items:center;justify-content:space-between;gap:24px;background:#e9eee1;border:1px solid #dbe3d0;border-radius:10px;padding:25px 28px;margin-bottom:20px}.experiment-banner h2{font-size:1.5rem;font-weight:500;margin:6px 0 10px}.experiment-banner h2 span{font-size:0.875rem;background:#d7e3cd;padding:4px 6px;border-radius:4px;vertical-align:middle;margin-left:6px}.experiment-banner p{font-size:0.875rem;color:#77836c}.banner-facts{display:flex;gap:27px}.banner-facts span{font-size:0.875rem;color:#79866e}.banner-facts b{display:block;font-size:1.5rem;font-weight:500;color:#46603b;margin-bottom:6px}.experiment-columns{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px}.test-metrics{display:grid;grid-template-columns:1.1fr 1.25fr .8fr;padding:8px 23px 23px;gap:15px}.test-metrics span{font-size:0.875rem;color:var(--muted)}.test-metrics strong{display:block;font-size:1.9375rem;font-weight:500;margin-top:12px;font-variant-numeric:tabular-nums}.test-metrics small{font-size:0.875rem;font-weight:400;color:var(--muted);margin-left:5px}.split-bar{display:flex;height:33px;border-radius:5px;overflow:hidden;margin:12px 0}.split-bar span{display:flex;align-items:center;justify-content:center;font-size:0.875rem}.train{background:#647f54;color:white}.validation{background:#b4c5a6;color:#4c6240}.test{background:#e0e7d7;color:#6a7b5e}.split-legend{display:flex;justify-content:space-between;font-size:0.875rem;color:var(--muted)}.data-detail{font-size:0.875rem;color:var(--muted);line-height:1.9;margin:23px 0 12px}.data-detail strong{font-weight:500;color:#626e57}details{font-size:0.875rem;color:#78866a;line-height:1.8}summary{cursor:pointer;color:var(--green)}details p{font-size:0.875rem;margin-top:9px;overflow-wrap:anywhere}.baseline-panel{margin-bottom:20px}.conclusion{font-size:0.875rem;color:#787b6c;background:#f7f5ec;border-left:3px solid #b79664;padding:14px 16px;line-height:1.9;margin-top:20px}.conclusion strong{font-weight:600;color:#6b684f}.best-score{color:#39634d;font-weight:600}.evidence-list>div,.roadmap>div{display:flex;gap:14px;margin:5px 0 23px}.evidence-list>div:last-child,.roadmap>div:last-child{margin-bottom:0}.check{color:#5d7850;background:#ecf2e6;width:20px;height:20px;flex-shrink:0;border-radius:50%;text-align:center;line-height:20px}.evidence-list h3,.roadmap h3{font-size:0.875rem;font-weight:500;margin-bottom:6px}.evidence-list p,.roadmap p{font-size:0.875rem;color:var(--muted);line-height:1.8}.roadmap>div>span{font-family:monospace;font-size:0.875rem;color:#89967a;padding-top:1px}.report-origin{font-size:0.875rem;margin-top:14px;overflow-wrap:anywhere}.boundary-note strong{font-weight:500}
@media(max-width:1100px){.experiment-columns{grid-template-columns:1fr}.experiment-banner{flex-wrap:wrap}.banner-facts{gap:35px}.test-metrics strong{font-size:1.75rem}}
@media(max-width:760px){.experiment-banner{padding:22px}.banner-facts{gap:22px;flex-wrap:wrap}.banner-facts b{font-size:1.3125rem}.test-metrics{padding:0 17px 20px;gap:8px}.test-metrics strong{font-size:1.4375rem}.test-metrics span{font-size:0.875rem}}
</style>
